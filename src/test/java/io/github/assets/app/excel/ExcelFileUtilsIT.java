...
public class ExcelFileUtilsIT {
    ...
    public void deserializeAssetAcquisitionsFile() throws IOException {
        ...
        // @formatter:off
        List<AssetAcquisitionEVM> acquisitions =
            assetAcquisitionExcelFileDeserializer.deserialize(toBytes(readFile("asset_acquisition.xlsx")));
        // @formatter:on
    ...
    public void deserializeDepreciationRegimeFile() throws IOException {
        ...
        List<DepreciationRegimeEVM> excelFileItems =
            depreciationRegimeExcelFileDeserializer.deserialize(toBytes(readFile("depreciation_regime.xlsx")));
        // @formatter:on
    ...
    public void deserializeFixedAssetAssessmentFile() throws IOException {
        ...
        List<FixedAssetAssessmentEVM> assessments =
            fixedAssetAssessmentExcelFileDeserializer.deserialize(toBytes(readFile("asset_assessment.xlsx")));
        // @formatter:on
    ...
    public void deserializeFixedAssetCategoryFile() throws IOException {
        ...
        List<FixedAssetCategoryEVM> categories =
            fixedAssetCategoryExcelFileDeserializer.deserialize(toBytes(readFile("asset_category.xlsx")));
        // @formatter:on
    ...
    public void deserializeFixedAssetInvoiceFile() throws IOException {
        ...
        List<FixedAssetInvoiceEVM> invoices =
            fixedAssetInvoiceExcelFileDeserializer.deserialize(toBytes(readFile("asset_invoice.xlsx")));
        // @formatter:on
    ...
    public void deserializeFixedAssetItemFile() throws IOException {
        ...
        List<FixedAssetItemEVM> assetItems =
            fixedAssetItemExcelFileDeserializer.deserialize(toBytes(readFile("asset_item.xlsx")));
        // @formatter:on
